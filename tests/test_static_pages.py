...
class StaticPageContentTestCase(unittest.TestCase):
    ...
    def test_entities_page_uses_daily_entity_columns_and_tier_ui(self):
        ...
        self.assertIn('id="entitiesRiderSearch"', html)
        self.assertIn('id="entitiesMerchantSearch"', html)
        ...
        self.assertIn("renderFilteredRiderRoster", js)
        self.assertIn("renderFilteredMerchantRoster", js)
