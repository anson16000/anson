...
def main() -> None:
    ...
    partners = [
        ...
        {"ID": "2", "合伙人公司名": "山西享派信息科技有限公司", "成立时间": "2025-12-01", "合伙人区域": "山西省 忻州市 原平市", "状态": "开启"},
    ]
    riders = [
        {"帮手ID": "3001", "帮手姓名": "张三", "入职时间": "2026-03-28", "状态": "正常", "所属合伙人": "广东帮啦网络技术有限公司", "区域": "广东省 梅州市 梅江区"},
        {"帮手ID": "3002", "帮手姓名": "李四", "入职时间": "2025-12-10", "状态": "正常", "所属合伙人": "山西享派信息科技有限公司", "区域": "山西省 忻州市 原平市"},
    ]
    merchants = [
        {"商家ID": "1001", "商家名称": "测试商家A", "所属合伙人": "广东帮啦网络技术有限公司", "所属区域": "广东省 梅州市 梅江区", "注册时间": "2026-03-30", "状态": "正常"},
        {"商家ID": "1002", "商家名称": "测试商家B", "所属合伙人": "山西享派信息科技有限公司", "所属区域": "山西省 忻州市 原平市", "注册时间": "2025-12-15", "状态": "正常"},
    ]
            ...
            orders.append(
                {
                    ...
                    "接单时间": (order_time + timedelta(minutes=2)).strftime("%Y-%m-%d %H:%M:%S"),
                    "取消时间": "",
